  ...
  return (
    <div className="min-h-screen bg-[#07070c] cyber-grid text-slate-200 font-sans p-4 md:p-6 flex flex-col justify-between select-none">
      ...
      <section className="space-y-4">
        ...
        {finalVerdict ? (
          <div className="bg-[#0b1411] border border-cyber-judge rounded-xl p-5 shadow-glow-judge relative overflow-hidden">
            ...
            <p className="text-slate-200 text-sm leading-relaxed font-sans">{finalVerdict}</p>
          </div>
        ) : turns.length > 0 ? (
